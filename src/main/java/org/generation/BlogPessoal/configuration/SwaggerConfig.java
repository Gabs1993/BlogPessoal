...
public class SwaggerConfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/Gabs1993")
				.contact(contact()).build();
	}

	private Contact contact() {
		return new Contact("Gabriel Conceicao", "https://github.com/Gabs1993", "gabrielcsantos1993@gmail.com");
	}
